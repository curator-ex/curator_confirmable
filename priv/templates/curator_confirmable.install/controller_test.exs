defmodule <%= base %>.ConfirmationControllerTest do
  use <%= base %>.ConnCase
  ...
  setup do
    ...
    unconfirmed_user = <%= base %>.User.changeset(%<%= base %>.User{}, user_attrs)
      |> <%= base %>.User.password_changeset(%{password: "TEST_PASSWORD", password_confirmation: "TEST_PASSWORD"})
      |> <%= base %>.Repo.insert!
